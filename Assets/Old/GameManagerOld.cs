...
public class GameManagerOld : MonoBehaviour
{
    ...
    public float levelConstraintTop = 13f; //The maximum positive Y value of the playable space.
    public float levelConstraintBottom = -7f; //The maximum negative Y value of the playable space.
    public float levelConstraintLeft = -16.5f; //The maximum negative X value of the playable space.
    public float levelConstraintRight = 19.5f; //The maximum positive X value of the playablle space.
